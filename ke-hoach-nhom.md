...
- [x] **run-5 — đo lại trọn bộ 31 case trên bản hiện tại (20:46–20:55, Claude chạy + chấm nháp; Duy + Nam đã duyệt, giữ nguyên điểm):** đạt mọi chiều của bar (ra câu 22/24 · khái niệm 22/22 · answer key 21/22 · lộ 1/22 · mức khó 22/22 · ①③ 6/6 · ② 3/3); **27/31 case đạt toàn bộ** (run-2: 23/31). Chưa đạt: G05 sai đáp án mà kiểm chéo cho qua, G07, G09, L4-03. Đã ghi `eval/run-5.md`, spec §7 + §9, `nop-cp4.md` (chuẩn đạt + kết quả + phần chưa xong). ✅ Đã push lên `anam` + `main` (commit 4fc8880).
