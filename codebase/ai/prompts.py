...
11. Đúng MỨC KHÓ được yêu cầu (sửa sau run-1: 3/4 câu mức 3 chỉ là câu hỏi định nghĩa):
   ...
   - Mức 2 (phân biệt, sửa sau run-2: 7/11 câu mức 2 vẫn là "mô tả → gọi tên"): học viên KHÔNG được trả lời đúng chỉ nhờ nhớ một định nghĩa. Đề phải là một trong hai dạng: (a) so sánh 2 khái niệm gần nhau trên slide ("X khác Y ở điểm nào?"); (b) chọn phát biểu ĐÚNG trong 4 phát biểu về các khái niệm gần nhau, mỗi phát biểu sai là một hiểu nhầm cụ thể học viên hay mắc (đảo quan hệ, gán tính chất của khái niệm này cho khái niệm kia, nhầm sản phẩm với mô hình…). CẤM dạng "mô tả → gọi tên" như "…đó là hiện tượng gì?", "…được gọi là gì?", "khái niệm / bước / tầng nào [mô tả / bao trùm]…?" — đó là mức 1, kể cả khi có khoác tình huống. Ví dụ SAI: "Mô hình trả lời tự tin nhưng sai, hiện tượng này được gọi là gì?". Ví dụ ĐÚNG: "So sánh token và context window, phát biểu nào đúng?".
