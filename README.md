...
**Lớp:** 3B · **Phòng:** E403 · **Cụm:** 6 · **Track:** A2

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
| Nguyễn Hải Nam | 2A202602476 | Đội trưởng · AI + vòng eval | Prompt, `generate_question()`, validator bám trang slide (`codebase/ai/`), trích `pages.json`; chạy eval từng lượt + phân tích case fail; chốt quality bar; spec §4 §9; nộp form |
| Nguyễn Trần Bảo Tâm | ______ | Evidence + data script | `mining.py`, `eval/extract_cases.py`; khảo sát ≥20 người + log; user test (`validation/`); spec §1 §2 §3 §8; slide |
| Trần Thị Thu Hiền | ______ | Frontend | `codebase/web/`: màn luyện 5 câu, 4 đường đi, màn kết quả; `concepts.json`; spec §6; video demo |
| Bùi Phương Duy | ______ | Bộ đo + backend | `eval/golden.csv`, `eval/run_eval.py`, rubric chấm tay; `codebase/api/`: API, rule mức khó, trace log; spec §5 §7 |
